...
namespace Kudos.Bot.Modules {
	...
	public sealed class Settings {
		...
		public async Task ChangeGuildSetting([CommandParameter] ISocketMessageChannel channel, [CommandParameter(0)] Word setting,
			[CommandParameter(1, null)] string value, [CommandParameter(2, null)] string key, [CommandParameter] SocketUser author) {
		...
		public async Task ChangeSetting(ISocketMessageChannel channel, Word setting, string value, string key, bool forServer, SocketUser author) {
